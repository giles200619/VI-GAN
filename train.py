...
parser.add_argument('--train_dir', dest='train_dir',  default='C:/Users/giles/Downloads/CVPR_NVS/chairs/chair_train' , help='training data dir')
...
parser.add_argument('--print_frequency', dest='print_frequency',  default=1,type=int, help='print loss every # of iteration')
